...
class Product(models.Model):
    ...
    availablity = models.CharField(choices=AVAILABLITY, null=True, max_length=100)
...
class CreateUser(UserCreationForm):
    email = forms.EmailField(required=True, error_messages={'exist': 'Email Already Exist'}, label="Email Id")
